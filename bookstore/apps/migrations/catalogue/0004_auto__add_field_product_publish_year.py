...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.publish_year'
        db.add_column('catalogue_product', 'publish_year',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.publish_year'
        db.delete_column('catalogue_product', 'publish_year')
