...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.description_url'
        db.add_column('catalogue_product', 'description_url',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.description_url'
        db.delete_column('catalogue_product', 'description_url')
    ...
    models = {
        ...
        'catalogue.product': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'description_url': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
        ...
        'catalogue.productimage': {
            'Meta': {'ordering': "['position']", 'object_name': 'ProductImage'},
