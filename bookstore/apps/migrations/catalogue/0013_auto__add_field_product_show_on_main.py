...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.show_on_main'
        db.add_column('catalogue_product', 'show_on_main',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.show_on_main'
        db.delete_column('catalogue_product', 'show_on_main')
