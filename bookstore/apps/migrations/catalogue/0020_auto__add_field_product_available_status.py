...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.available_status'
        db.add_column('catalogue_product', 'available_status',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.available_status'
        db.delete_column('catalogue_product', 'available_status')
