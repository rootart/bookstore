...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.homepage_position'
        db.add_column('catalogue_product', 'homepage_position',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Product.category_position'
        db.add_column('catalogue_product', 'category_position',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Product.catalogue_position'
        db.add_column('catalogue_product', 'catalogue_position',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.homepage_position'
        db.delete_column('catalogue_product', 'homepage_position')

        # Deleting field 'Product.category_position'
        db.delete_column('catalogue_product', 'category_position')

        # Deleting field 'Product.catalogue_position'
        db.delete_column('catalogue_product', 'catalogue_position')
