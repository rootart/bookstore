...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.catalogue_image'
        db.add_column('catalogue_product', 'catalogue_image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Product.main_cover_image'
        db.add_column('catalogue_product', 'main_cover_image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.catalogue_image'
        db.delete_column('catalogue_product', 'catalogue_image')

        # Deleting field 'Product.main_cover_image'
        db.delete_column('catalogue_product', 'main_cover_image')
    ...
    models = {
        ...
        'catalogue.product': {
            ...
            'catalogue_image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            ...
            'main_cover_image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
