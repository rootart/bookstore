...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BindingType'
        db.create_table('catalogue_bindingtype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('catalogue', ['BindingType'])

        # Adding field 'Product.binding_type'
        db.add_column('catalogue_product', 'binding_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalogue.BindingType'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'BindingType'
        db.delete_table('catalogue_bindingtype')

        # Deleting field 'Product.binding_type'
        db.delete_column('catalogue_product', 'binding_type_id')
