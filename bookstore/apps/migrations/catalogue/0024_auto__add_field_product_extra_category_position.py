...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.extra_category_position'
        db.add_column('catalogue_product', 'extra_category_position',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.extra_category_position'
        db.delete_column('catalogue_product', 'extra_category_position')
