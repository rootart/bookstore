...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.extra_category'
        db.add_column('catalogue_product', 'extra_category',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='products_extra', null=True, to=orm['catalogue.Category']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.extra_category'
        db.delete_column('catalogue_product', 'extra_category_id')
