...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('catalogue_product', 'available')

        # Deleting field 'Product.anticipating'
        db.delete_column('catalogue_product', 'anticipating')

        # Deleting field 'Product.not_available'
        db.delete_column('catalogue_product', 'not_available')


    def backwards(self, orm):
        # Adding field 'Product.available'
        db.add_column('catalogue_product', 'available',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Product.anticipating'
        db.add_column('catalogue_product', 'anticipating',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Product.not_available'
        db.add_column('catalogue_product', 'not_available',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
