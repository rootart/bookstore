...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('catalogue_product', 'price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=2))

        # Changing field 'Product.stock_price'
        db.alter_column('catalogue_product', 'stock_price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'Product.price'
        db.alter_column('catalogue_product', 'price', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'Product.stock_price'
        db.alter_column('catalogue_product', 'stock_price', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))
