...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.additional_name_info'
        db.add_column('catalogue_product', 'additional_name_info',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.additional_name_info'
        db.delete_column('catalogue_product', 'additional_name_info')
