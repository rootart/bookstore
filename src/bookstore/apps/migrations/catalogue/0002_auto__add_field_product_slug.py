...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('catalogue_product', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default=datetime.datetime(2013, 2, 9, 0, 0), unique=True, max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.slug'
        db.delete_column('catalogue_product', 'slug')
